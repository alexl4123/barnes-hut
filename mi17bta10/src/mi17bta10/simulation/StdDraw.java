 ...
 *  Compilation:  javac mi17bta10.simulation.StdDraw.java
 *  Execution:    java mi17bta10.simulation.StdDraw
 *  Dependencies: none
 *
...
/**
 * The {@code mi17bta10.simulation.StdDraw} class provides a basic capability for
 * creating drawings with your programs. It uses a simple graphics model that
 ...
 * <p>
 * <b>Getting started.</b>
 * To use this class, you must have {@code mi17bta10.simulation.StdDraw.class} in your
 * Java classpath. If you used our autoinstaller, you should be all set.
 * Otherwise, either download
 * <a href = "https://introcs.cs.princeton.edu/java/code/stdlib.jar">stdlib.jar</a>
 * and add to your Java classpath or download
 * <a href = "https://introcs.cs.princeton.edu/java/stdlib/StdDraw.java">mi17bta10.simulation.StdDraw.java</a>
 ...
 *           mi17bta10.simulation.StdDraw.setPenRadius(0.05);
 *           mi17bta10.simulation.StdDraw.setPenColor(mi17bta10.simulation.StdDraw.BLUE);
 *           mi17bta10.simulation.StdDraw.point(0.5, 0.5);
 *           mi17bta10.simulation.StdDraw.setPenColor(mi17bta10.simulation.StdDraw.MAGENTA);
 *           mi17bta10.simulation.StdDraw.line(0.2, 0.2, 0.8, 0.2);
 *       }
 *   }
 *  </pre>
 ...
 * The methods {@code mi17bta10.simulation.StdDraw.line()} and {@code mi17bta10.simulation.StdDraw.point()}
 * draw lines and points; the methods {@code mi17bta10.simulation.StdDraw.setPenRadius()}
 * and {@code mi17bta10.simulation.StdDraw.setPenColor()} control the line thickness and color.
 * p>
 ...
 * and represented in degrees. For example, {@code mi17bta10.simulation.StdDraw.arc(0.0, 0.0, 1.0, 0, 90)}
 ...
 *  mi17bta10.simulation.StdDraw.filledPolygon(x, y);
 * </pre>
 * p>
 * <b>Pen size.</b>
 ...
 * </ul>
 * p>
 * For example, {@code mi17bta10.simulation.StdDraw.setPenRadius(0.025)} makes
 ...
 * For example, {@code mi17bta10.simulation.StdDraw.setPenColor(mi17bta10.simulation.StdDraw.MAGENTA)} sets the
 ...
 * For example, {@code mi17bta10.simulation.StdDraw.setCanvasSize(800, 800)}
 ...
 * leave a small margin, you can call {@code mi17bta10.simulation.StdDraw.setScale(-.05, 1.05)}.
 * p>
 ...
 *  mi17bta10.simulation.StdDraw.setFont(font);
 *  mi17bta10.simulation.StdDraw.text(0.5, 0.5, "Hello, World");
 * </pre>
 * p>
 * <b>Images.</b>
 ...
 * {@code mi17bta10.simulation.StdDraw.clear(mi17bta10.simulation.StdDraw.LIGHT_GRAY)} clears the canvas to a shade
 * of gray.
 * p>
 ...
 * <pre>
 *  mi17bta10.simulation.StdDraw.setScale(-2, +2);
 *  mi17bta10.simulation.StdDraw.enableDoubleBuffering();
 *
 *  for (double t = 0.0; true; t += 0.02) {
 *      double x = Math.sin(t);
 *      double y = Math.cos(t);
 *      mi17bta10.simulation.StdDraw.clear();
 *      mi17bta10.simulation.StdDraw.filledCircle(x, y, 0.05);
 *      mi17bta10.simulation.StdDraw.filledCircle(-x, -y, 0.05);
 *      mi17bta10.simulation.StdDraw.show();
 *      mi17bta10.simulation.StdDraw.pause(20);
 *  }
 * </pre>
 * p>
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    /**
     * Set mi17bta10.simulation.StdDraw canvas to isVisible
     *
     * @param setIsVisible - if true, then set canvas visible, else set to not visible
     */
    public static void setVisible(boolean setIsVisible) {
        if (frame != null) {
            frame.setVisible(setIsVisible);
        }
        isVisible = false;
    }
    ...
    private static JMenuBar createMenuBar() {
        ...
        menuItem1.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_S,
                Toolkit.getDefaultToolkit().getMenuShortcutKeyMask())); //TODO - Deprecated
        menu.add(menuItem1);
        return menuBar;
    }
     ...
     * {@code mi17bta10.simulation.StdDraw.BLACK}, {@code mi17bta10.simulation.StdDraw.BLUE}, {@code mi17bta10.simulation.StdDraw.CYAN},
     * {@code mi17bta10.simulation.StdDraw.DARK_GRAY}, {@code mi17bta10.simulation.StdDraw.GRAY}, {@code mi17bta10.simulation.StdDraw.GREEN},
     * {@code mi17bta10.simulation.StdDraw.LIGHT_GRAY}, {@code mi17bta10.simulation.StdDraw.MAGENTA}, {@code mi17bta10.simulation.StdDraw.ORANGE},
     * {@code mi17bta10.simulation.StdDraw.PINK}, {@code mi17bta10.simulation.StdDraw.RED}, {@code mi17bta10.simulation.StdDraw.WHITE}, and
     * {@code mi17bta10.simulation.StdDraw.YELLOW}.
     *
    ...
    private static Image getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to mi17bta10.simulation.StdDraw)
        if ((icon == null) || (icon.getImageLoadStatus() != MediaTracker.COMPLETE)) {
...
/*
    private static BufferedImage getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to mi17bta10.simulation.StdDraw)
        try {
            URL url = mi17bta10.simulation.StdDraw.class.getResource(filename);
            BufferedImage image = ImageIO.read(url);
            return image;
        } 
        catch (IOException e) {
